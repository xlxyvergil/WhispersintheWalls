...
public interface SharedSuggestionProvider {
   ...
   static <T> void filterResources(Iterable<T> p_82945_, String p_82946_, Function<T, ResourceLocation> p_82947_, Consumer<T> p_82948_) {
      ...
      for(T t : p_82945_) {
         ...
         } else if (matchesSubStr(p_82946_, resourcelocation.getNamespace()) || matchesSubStr(p_82946_, resourcelocation.getPath())) { // Forge: Removed "minecraft" namespace requirement for path searching to allow modded path suggestions to show up
            p_82948_.accept(t);
         }
      }
