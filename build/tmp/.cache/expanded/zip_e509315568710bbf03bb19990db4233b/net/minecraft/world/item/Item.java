...
public class Item implements FeatureElement, ItemLike, net.minecraftforge.common.extensions.IForgeItem {
   ...
   protected static BlockHitResult getPlayerPOVHitResult(Level p_41436_, Player p_41437_, ClipContext.Fluid p_41438_) {
      ...
      float f6 = f3 * f4;
      float f7 = f2 * f4;
      double d0 = p_41437_.getAttributeValue(net.minecraftforge.common.ForgeMod.BLOCK_REACH.get()) + 0.5; // Block reach is 4.5, vanilla uses 5.0 here, so add 0.5 padding
