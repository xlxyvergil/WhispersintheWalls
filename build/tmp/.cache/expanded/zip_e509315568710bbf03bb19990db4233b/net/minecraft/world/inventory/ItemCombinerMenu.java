...
public abstract class ItemCombinerMenu extends AbstractContainerMenu {
   ...
   public boolean stillValid(Player p_39780_) {
      return this.access.evaluate((p_39785_, p_39786_) -> {
         ...
         double reach = p_39780_.getAttributeValue(net.minecraftforge.common.ForgeMod.BLOCK_REACH.get()) + 3.5;
         return !this.isValidBlock(p_39785_.getBlockState(p_39786_)) ? false : p_39780_.distanceToSqr((double)p_39786_.getX() + 0.5D, (double)p_39786_.getY() + 0.5D, (double)p_39786_.getZ() + 0.5D) <= reach * reach;
      }, true);
   }
